...
#define PXI_REGS_BASE   (MAP_ADDR + 0xA1000)
...
#define REG_PXI_CNT     *(vu16 *)(PXI_REGS_BASE + 4)
    ...
    #define CNT_RECEIVE_FIFO_FULL_STATUS            (1U <<  9)
...
bool PXIIsReceiveFIFOFull(void);
